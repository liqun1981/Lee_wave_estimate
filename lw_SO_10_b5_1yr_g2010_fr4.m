...
% Author     | Luwei Yang
%=====================================================================================
% Log        | 2017-05-20 Mask shallow areas; 
...
% Topography -- G2010 (more coverage)
[x,y,theta] = grdread2('../goff2010_grids/goff2010_theta.grd');
[x,y,nu]    = grdread2('../goff2010_grids/goff2010_nu.grd');
[x,y,ks]    = grdread2('../goff2010_grids/goff2010_ks.grd');
[x,y,kn]    = grdread2('../goff2010_grids/goff2010_kn.grd');
[x,y,hrms]  = grdread2('../goff2010_grids/goff2010_h.grd');
tlon  = double(x);
tlat  = double(y);
theta = double(theta);
theta = theta/180*pi;
nu    = double(nu);
ks    = double(ks); ks = ks/1000*2*pi;
kn    = double(kn); kn = kn/1000*2*pi;
hrms  = double(hrms);
...
% iFrc = 0.4 
% save /short/v45/lxy581/lw/corr_fin_topog/lw_SO_10_b5_1yr_g2010_170520_fr4.mat lon lat mdisp_nl Mdisp_nl mEdisp_nl Cdisp_nl
% save /short/v45/lxy581/lw/corr_fin_topog/lw_SO_10_b5_1yr_g2010_170531_fr4.mat lon lat mdisp_nl Mdisp_nl mEdisp_nl Cdisp_nl
% Use bottom 500m-averaged last year-averaged stratification
%save /short/v45/lxy581/lw/corr_fin_topog/lw_SO_10_b5_1yr_g2010_171118_fr4.mat lon lat mdisp_nl Mdisp_nl mEdisp_nl Cdisp_nl
% Correct the unit for stratification (s-1 to rad s-1)
%save /short/v45/lxy581/lw/corr_fin_topog/lw_SO_10_b5_1yr_g2010_180123_fr4.mat lon lat mdisp_nl Mdisp_nl mEdisp_nl Cdisp_nl
% remove *2pi for N
save /short/v45/lxy581/lw/corr_fin_topog/lw_SO_10_b5_1yr_g2010_180129_fr4.mat lon lat mdisp_nl Mdisp_nl mEdisp_nl Cdisp_nl miwx miwy

% iFrc = 4.0 
% save /short/v45/lxy581/lw/corr_fin_topog/lw_SO_10_b5_1yr_g2010_170528_fr4.mat lon lat mdisp_nl Mdisp_nl mEdisp_nl Cdisp_nl
